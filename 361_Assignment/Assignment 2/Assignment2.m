...
rgb1 = image1;
imwrite(image1,"./ResultPicture/S3-im1.png");
...
rgb2 = image2;
imwrite(image2,"./ResultPicture/S3-im2.png");
image2 = rgb2gray(image2);
Fast2 = my_fast_detector(image2,0.05);
Faster2 = Harris(image2,Fast2);
%imshow([Fast1 Faster1; Fast2 Faster2]);
imwrite(Fast1,"./ResultPicture/S3-fast.png");
imwrite(Faster1,"./ResultPicture/S3-fastR.png");
...
saveas(gcf, './ResultPicture/S3-fastMatch.png');
...
saveas(gcf,'./ResultPicture/S3-fastRMatch.png');
...
figure
imshow(panorama);
imwrite(panorama,"./ResultPicture/S3-panorama.png");
